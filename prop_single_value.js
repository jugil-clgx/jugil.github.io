(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["prop_single_value"] = factory();
	else
		root["prop_single_value"] = factory();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_prop_single_value_scss__ = __webpack_require__(711);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_prop_single_value_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__common_prop_single_value_scss__);


var vis = {
    id: 'prop_single_value',
    label: 'Prop Single Value',
    options: {
        textWeight: {
            type: 'string',
            label: 'Text Weight',
        ...
        dimensionTextOverride: {
            type: 'string',
            label: 'Dimension Text Override Title',
            default: ''
        },
        borderSpacing: {
            type: 'number',
    ...
    update: function (data, element, config, queryResponse, details) {
        ...
        var dimensionTextOverride = config.dimensionTextOverride || this.options.dimensionTextOverride.default;
        ...
        data.forEach(function (datum) {
            if (typeof (dimensions) != "undefined") {
                dimensions.forEach(function (d) {
                    headerLabels.push({ 'label': typeof (dimensionTextOverride) != "undefined" && dimensionTextOverride.length > 0 ? dimensionTextOverride : d.label_short });
                    headerLabels.push({ 'label': typeof (datum[d.name]["html"]) != "undefined" && datum[d.name]["html"].length > 0 ? datum[d.name]["html"] : datum[d.name]["value"] });
                });
            }
        });
        ...
        table.append('thead').append('tr')
            ...
            __WEBPACK_IMPORTED_MODULE_0_d3__["n" /* select */](this).selectAll('thText')
                ...
                .style('font-family', function (d) { return textFontFamily; })
                .style('text-shadow', function (d) { return textShadow; })
                .style('color', function (d) { return textFill; })
...
if(false) {
	module.hot.accept("!!../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/lib/loader.js!./prop_single_value.scss", function() {
		var newContent = require("!!../../node_modules/css-loader/dist/cjs.js!../../node_modules/sass-loader/lib/loader.js!./prop_single_value.scss");
...
// Module
exports.push([module.i, "/*th { text-align: left; }\r\nth, td { padding: 0 1em 0.5ex 0;}\r\nth.center, td.center { text-align: center; }\r\nth.num, td.num { text-align: right; }*/\niframe {\n  padding: 0px !important; }\n\n#prop-single-value iframe {\n  padding: 0px !important; }\n\niframe#prop-single-value {\n  padding: 0px !important; }\n\n.vis-container iframe {\n  padding: 0px !important; }\n\n#vis, .vis-container iframe {\n  padding: 0px !important; }\n\n#vis, .vis-container {\n  overflow: inherit !important;\n  margin: 0px !important; }\n\ntable#prop-single-value tr td:last-child {\n  border-right: none !important; }\n\ntable#prop-single-value tr th:last-child {\n  border-right: none !important; }\n", ""]);
